...
export function LiveWallpaper() {
    return (
        <div className="fixed inset-0 -z-50 h-full w-full bg-black">
            ...
            <div className="absolute inset-0 z-10 bg-[#000000]/50" />

            {/* Optional: Adds a subtle vignette (darker edges) */}
            <div className="absolute inset-0 z-20 bg-[radial-gradient(circle_at_center,transparent_0%,#000000_100%)] opacity-10" />
            ...
            >
                ...
                <source src="/videos/cyberpunk-city.1920x1080.mp4" type="video/mp4" />
            </video>
        </div>
    );
}