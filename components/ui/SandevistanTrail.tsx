...
export function SandevistanTrail() {
  ...
  useEffect(() => {
    ...
    // This effect is driven entirely by mousemove, which never fires on
    // touch devices. Without this check it still runs a requestAnimationFrame
    // loop forever on phones for an effect that can never be seen - pure
    // battery/CPU drain.
