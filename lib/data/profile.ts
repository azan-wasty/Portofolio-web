...
export const profile = {
    ...
    longBio:
        "I build full-stack products end to end and have deployed accurate ML models. Most of my personal work centers on ML , Management Systems , Community Driven Apps. I try to build stuff that people and most importantly I'd like to use.",
};
