...
export function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 border-b-2 border-[#fcee0a] bg-[#000000]">
            ...
            */}
            <nav className="flex w-full items-center px-4 py-2 sm:px-6">
                ...
                <ul className="ml-320 hidden gap-6 font-mono text-sm uppercase tracking-wider text-[#fcee0a] sm:flex">
                    {navLinks.map((link) => (
                        <li key={link.href}>
                            <Link
