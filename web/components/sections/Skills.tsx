          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {skillGroups.map((group, index) => (
              ...
              >
                ...
                <div className="absolute -left-[1px] -top-[1px] h-3 w-3 border-l-2 border-t-2 border-signal-cyan/30 transition-colors group-hover:border-signal-cyan/80" />
                <div className="absolute -bottom-[1px] -right-[1px] h-3 w-3 border-b-2 border-r-2 border-signal-cyan/30 transition-colors group-hover:border-signal-cyan/80" />

                {/* Cyberpunk Module Header */}
                <div className="mb-5 flex items-end justify-between border-b border-neutral-800 pb-2">
                  <h3 className="font-mono text-sm font-bold uppercase tracking-widest text-signal-cyan">
                    {group.label}
                  </h3>
