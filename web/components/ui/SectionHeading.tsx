...
export function SectionHeading({
  ...
  return (
    ...
    >
      <span
        className={`font-mono text-sm ${inverted ? "text-signal-cyan" : "text-signal-red"
          }`}
      >
        {index}
      </span>
      ...
      <div>
        <h2
          className={`cyber-heading font-signature text-2xl tracking-wide sm:text-3xl ${inverted ? "text-signal-yellow" : "text-text-primary"
            }`}
        >
          {title}
        </h2>
